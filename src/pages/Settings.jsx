          ...
          >
            <div className="settings-card-header">
              <div>
                <h2>Preferences</h2>
                <p>
                  Personalize how Offerly looks and opens.
                </p>
              </div>
            </div>
            ...
            <div className="settings-rows">
              <div className="setting-row">
                <div className="setting-copy">
                  <h3>Dark mode</h3>
                  <p>
                    Use Offerly's dark appearance across the app.
                  </p>
                </div>
              ...
              <div className="setting-row">
                <div className="setting-copy">
                  <h3>Default page</h3>
                  <p>
                    Choose which page opens after you sign in.
                  </p>
                </div>
          ...
          >
            <div className="settings-card-header">
              <div>
                <h2>Notifications</h2>
                <p>
                  Control the reminders Offerly uses to keep you on
                  track.
                </p>
              </div>
            </div>
            ...
            <div className="settings-rows">
              <div className="setting-row">
                <div className="setting-copy">
                  ...
                  <p>
                    Remind me when an application is ready for a
                    follow-up.
                  </p>
                </div>
                ...
                <label className="toggle-switch">
                  <input
                    type="checkbox"
                    checked={
                      preferences.applicationReminders
                    }
                    onChange={(event) =>
                      updatePreference(
              ...
              <div className="setting-row">
                <div className="setting-copy">
                  ...
                  <p>
                    Remind me before scheduled interviews and
                    assessments.
                  </p>
                </div>
                ...
                <label className="toggle-switch">
                  <input
                    type="checkbox"
                    checked={preferences.interviewAlerts}
                    onChange={(event) =>
                      updatePreference(
                        "interviewAlerts",
                        event.target.checked
              ...
              <div className="setting-row">
                <div className="setting-copy">
                  ...
                  <p>
                    Receive a weekly overview of your job-search
                    activity.
                  </p>
                </div>
